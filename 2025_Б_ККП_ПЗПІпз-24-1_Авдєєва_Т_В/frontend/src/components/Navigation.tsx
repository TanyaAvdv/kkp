...
const navigation = [
  ...
  { name: 'Contacts', href: '/contacts', icon: PhoneIcon, current: false },
  { name: 'Clients', href: '/clients', icon: UserGroupIcon, current: false },
  { name: 'Estates', href: '/estates', icon: BuildingOfficeIcon, current: false },
  { name: 'Contracts', href: '/contracts', icon: DocumentTextIcon, current: false },
  { name: 'Requests', href: '/requests', icon: ClipboardDocumentListIcon, current: false },
  { name: 'Offers', href: '/offers', icon: TagIcon, current: false },
];
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <div className="flex items-center gap-x-4 lg:gap-x-6">
                <h1 className="text-xl font-semibold leading-6 text-gray-900">{currentPageName}</h1>
              </div>
            </div>
          </div>
